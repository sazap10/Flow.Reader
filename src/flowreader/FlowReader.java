...
private Stage priStage;
    ...
    public void start(Stage primaryStage) {
        ...
        mainView2.sideBtnsBar.setLayoutY(screenBounds.getHeight() - 26 * 7);

        //mainView2.prefWidthProperty().bind(rootPane2.widthProperty());
        //mainView2.prefHeightProperty().bind(rootPane2.heightProperty());
...
//splitPane.prefHeightProperty().bind(scene.heightProperty());
    ...
    public void split() {
        ...
        if (split_toggle) {
            ...
            rootPane2.setMaxWidth(screenBounds.getWidth());
            rootPane2.setMinWidth(screenBounds.getWidth());
            rootPane2.setPrefWidth(screenBounds.getWidth());
